...
public class GoForwardCommand implements Command {
    ...
    private static final String TAG = GoForwardCommand.class.getSimpleName();
    ...
    public GoForwardCommand(RegulatedMotor leftMotorRegulator, RegulatedMotor rightMotorRegulator, int speedToLeft, int speedToRight) {
