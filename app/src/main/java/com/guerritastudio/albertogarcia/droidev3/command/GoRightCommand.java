...
public class GoRightCommand implements Command {
    ...
    private static final String TAG = GoRightCommand.class.getSimpleName();
    ...
    public GoRightCommand(RegulatedMotor leftMotorRegulator, RegulatedMotor rightMotorRegulator, int speedToLeft, int speedToRight){
